...
const content: Record<Exclude<PublicPageKind, "pricing">, { eyebrow: string; title: string; body: string[] }> = {
  ...
  dataDeletion: {
    ...
    body: [
      "თუ გსურთ NexaReply ანგარიშის, ორგანიზაციის ან დაკავშირებული Facebook Page-ის მონაცემების წაშლა, შედით თქვენს ანგარიშში როგორც ორგანიზაციის owner და Overview-ის „მონაცემების წაშლის მოთხოვნა“ ბლოკიდან გაგზავნეთ მოთხოვნა. მოთხოვნა ავტომატურად უკავშირდება მხოლოდ authenticated session-ის ელფოსტას.",
  ...
  contact: {
    ...
    body: [
      "დაიწყეთ Amadeo perfume demo-ით, შემდეგ კი მოამზადეთ თქვენი პროდუქტის კატალოგი, ბიზნეს წესები და პასუხების ტონი რეალური workspace-ისთვის.",
