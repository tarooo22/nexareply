...
| App Basic policy fields | Terms and Data Deletion Instructions now point to NexaReply public routes; the routes are live and the deletion page links to the authenticated owner workflow. | No code-side policy URL blocker remains; preserve these exact URLs in Meta Dashboard. |
...
1. **Completed:** In **App settings → Basic**, set **Terms of Service URL** to `https://nexareply-2chxuc4s.manus.space/terms`.
2. **Completed:** In **User data deletion**, set **Data deletion instructions URL** to `https://nexareply-2chxuc4s.manus.space/data-deletion`.
